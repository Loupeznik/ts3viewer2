...
/* tslint:disable */
/* eslint-disable */
/* biome-ignore lint/suspicious/noExplicitAny: auto-generated code */
/* biome-ignore lint/complexity/noStaticOnlyClass: auto-generated code */
/* tslint:disable */
/* eslint-disable */
...
export class ClientService {
   ...
   * @throws ApiError
   */
  public static getApiV1ServerClients(getDetail?: boolean): CancelablePromise<Array<ClientDto>> {
   ...
   * @throws ApiError
   */
  public static getApiV1ServerClientsKick(id: number): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static postApiV1ServerClientsBan(id: number, requestBody?: BanClientDto): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: "POST",
   ...
   * @throws ApiError
   */
  public static postApiV1ServerClientsPoke(id: number, requestBody?: MessageDto): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: "POST",
