...
export class AudioBotService {
   ...
   * @throws ApiError
   */
  public static putApiV1AudiobotVolume(requestBody?: VolumeDto): CancelablePromise<VolumeDto> {
    return __request(OpenAPI, {
      method: "PUT",
      url: "/api/v1/audiobot/volume",
      body: requestBody,
   ...
   * @throws ApiError
   */
  public static postApiV1AudiobotSongPlay(requestBody?: SongDto): CancelablePromise<SongDto> {
    return __request(OpenAPI, {
      method: "POST",
   ...
   * @throws ApiError
   */
  public static postApiV1AudiobotMove(requestBody?: MoveBotDto): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: "POST",
